...
enyo.path.addPaths({layout: "/home/morphis/data/oe/webos-ports-setup/webos-ports/work/preware-enyo2/enyo/../lib/layout/", onyx: "/home/morphis/data/oe/webos-ports-setup/webos-ports/work/preware-enyo2/enyo/../lib/onyx/", onyx: "/home/morphis/data/oe/webos-ports-setup/webos-ports/work/preware-enyo2/enyo/../lib/onyx/source/", model: "source/model/"});
...
kind: onyx.Button,
content: "getMachineName",
ontap: "machineName"
}, {
kind: onyx.Button,
content: "loadFeeds",
ontap: "startLoadFeeds"
}, {
kind: enyo.Scroller,
fit: !0,
components: [ {
name: "out",
content: "press button...<br>",
allowHtml: !0,
fit: !0
} ]
} ]
...
log: function(e) {
this.$.out.addContent(e + "<br>");
},
deviceready: function(e, t) {
this.log("device ready received, yeah. :)"), PalmServiceBridge ? this.log("PalmServiceBridge seems to exist.") : this.log("No PalmServiceBridge... not running on device?? :(");
},
...
preware.IPKGService.getMachineName(this.gotMachineName.bind(this)), this.log("getting machine name.");
},
gotMachineName: function(e) {
this.log("Got machinename: " + e + " (" + JSON.stringify(e) + ")");
},
startLoadFeeds: function() {
this.log("starting to load feeds."), preware.DeviceProfile.getDeviceProfile(this.gotDeviceProfile.bind(this), !1), this.log("...");
},
gotDeviceProfile: function(e, t) {
this.log("got device profile: " + t && t.success), !t.success || !t.deviceProfile ? (this.log("failure..."), this.subscription = preware.IPKGService.getMachineName(this.onDeviceType.bind(this)), this.log("getting machine name.")) : (this.log("got deviceProfile: " + JSON.stringify(t.deviceProfile)), this.deviceProfile = t.deviceProfile, preware.PalmProfile.getPalmProfile(this.gotPalmProfile.bind(this), !1));
},
gotPalmProfile: function(e, t) {
!t.success || !t.palmProfile ? (this.log("failure..."), this.subscription = preware.IPKGService.getMachineName(this.onDeviceType.bind(this)), this.log("getting machine name.")) : (this.log("got palmProfile."), this.palmProfile = t.palmProfile, this.subsciption = preware.IPKGService.setAuthParams(this.authParamsSet.bind(this), this.deviceProfile.deviceId, this.palmProfile.token));
},
authParamsSet: function(e) {
this.log("got authParams: " + JSON.stringify(e)), this.subscription = preware.IPKGService.getMachineName(this.onDeviceType.bind(this)), this.log("getting machine name.");
},
onDeviceType: function(e) {
this.log("request connection status."), navigator.service.Request("palm://com.palm.connectionmanager", {
method: "getstatus",
...
var t = !1;
e && e.returnValue === !0 && (e.isInternetConnectionAvailable === !0 || e.wifi.state === "connected") && (t = !0), this.log("got connection status. connection: " + t), this.log("Run version check"), this.subscription = preware.IPKGService.version(this.onVersionCheck.bind(this, t));
},
onVersionCheck: function(e, t) {
this.log("version check returned: " + JSON.stringify(t));
try {
preware.IPKGService.logPayload(t, "VersionCheck"), t ? t.errorCode !== undefined ? t.errorText === "org.webosinternals.ipkgservice is not running." ? this.log($L("The service is not running. First try restarting Preware, or reboot your device and try again.")) : this.log(t.errorText) : t.apiVersion && t.apiVersion < this.ipkgServiceVersion ? this.log($L("The service version is too old. First try rebooting your device, or reinstall Preware and try again.")) : e && !this.onlyLoad ? (this.log("start loading feeds."), this.subscription = preware.FeedsModel.loadFeeds(this.downLoadFeeds.bind(this)), this.log("...")) : this.downLoadFeeds() : this.log($L("Cannot access the service. First try restarting Preware, or reboot your device and try again."));
} catch (n) {
...
this.subscription && this.subscription.cancel(), this.log($L("<strong>Downloading Feed Information</strong><br>") + this.feeds[e].name), this.subscription = preware.IPKGService.downloadFeed(this.downloadFeedResponse.bind(this, e), this.feeds[e].gzipped, this.feeds[e].name, this.feeds[e].url);
},
downloadFeedResponse: function(e, t) {
t.returnValue === !1 || t.stage === "failed" ? this.log(t.errorText + "<br>" + t.stdErr.join("<br>")) : t.stage === "status" ? this.log($L("<strong>Downloading Feed Information</strong><br>") + this.feeds[e].name + "<br><br>" + t.status) : t.stage === "completed" && (e += 1, e < this.feeds.length ? this.downloadFeedRequest(e) : (this.log($L("<strong>Done Downoading!</strong>")), preware.PrefCookie.put("lastUpdate", Math.round((new Date).getTime() / 1e3)), this.loadFeeds()));
}
});
...
deleteAll: function() {
enyo.error("faking delete all success!"), this.doDeleteAll({
success: !1
});
},
deleteAllSuccess: function() {
enyo.log("Delete all success."), this.doDeleteAll({
success: !0
});
},
deleteAllFailure: function(e, t, n) {
enyo.error("delete all failure: ", t), this.doDeleteAll({
success: !1
});
},
...
this.callback = e;
try {
this.feeds = [], this.subscription = IPKGService.list_configs(this.onConfigs.bind(this));
} catch (t) {
